...
O Restaurante Mata Fome, localizado na região, atua no segmento de serviço à la carte e está em fase de modernização de suas operações. Com o intuito de otimizar o atendimento e os processos internos, o estabelecimento implementará o uso de tablets e celulares como ferramentas de apoio à gestão de pedidos e fechamento de contas.
...
Abrir uma conta associada à mesa;
Realizar pedidos diretamente pelo dispositivo;
Iniciar o processo de encerramento da conta, facilitando o pagamento.
A estrutura funcional do restaurante é dividida em diferentes cargos, cada qual com responsabilidades específicas dentro do sistema:
Gerente: responsável pela administração e gestão global do restaurante, com as seguintes funções:
Realizar a compra de insumos necessários para o funcionamento da cozinha;
Cadastrar ou remover funcionários no sistema;
Criar e gerenciar as receitas dos pratos servidos no restaurante.
Garçom: responsável pelo atendimento ao cliente e pela interação direta com os pedidos, com as seguintes atribuições:
Entregar os pedidos nas mesas;
Auxiliar os clientes no uso do tablet para realização de pedidos, quando necessário;
Fechar as contas dos clientes no sistema, mediante solicitação.
Cozinheiro: responsável pela preparação dos pratos solicitados pelos clientes, com as seguintes responsabilidades:
Receber os pedidos através do sistema;
Preparar os pratos conforme solicitado;
Alterar o status do pedido para "Pronto", sinalizando que está disponível para entrega pelo garçom.
Esse sistema tem como objetivo proporcionar maior eficiência no atendimento e uma experiência de usuário mais ágil e moderna para clientes e funcionários. Além disso, a automação de processos como o registro de pedidos e o fechamento de contas visa reduzir erros operacionais e melhorar a comunicação entre os diferentes setores do restaurante.
